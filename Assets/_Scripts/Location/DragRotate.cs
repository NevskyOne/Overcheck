...
public class DragRotate : MonoBehaviour
{
    ...
    private Movable _targetMovable;
    
    private void OnEnable()
    {
        _worldCanvas.SetActive(true);
        _targetTransform = transform.GetChild(0);
        _targetMovable = _targetTransform.GetComponent<Movable>();
        _objName.text = _targetMovable.Title;
        _objDescript.text = _targetMovable.Description;
