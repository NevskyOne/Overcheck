...
public struct RandomParamSt
{
    ...
    public static readonly List<DialogConfig> NormalConfigs = Resources.LoadAll<DialogConfig>("Scriptable/NormalNPC/New Config").ToList();
