...
public struct RandomParamSt
{
    ...
    public static readonly List<string> RobotsReplics = new() {"Д А * Т Е С В О И Д * К У М Е Н Т Ы", "Не бойййййтесь! Это обычная процеду-ду-ду-ду-ра", "Дайте мне ПРОВЕРИТЬ ваше лицо!!", "Можете пере-ре-ре-ре-дать мне св*и документы.......", "Void! К НЕБЕСАМ.","Повторииииите пожалуйста ваше имя!","Мы не имеем право причи-чи-чи-чи-нять вам вреда! НЕ БОЙТЕСЬ!" };
    public static readonly List<Sprite> Photos = Resources.LoadAll<Sprite>("BearPhotos").ToList();
    public static readonly List<DialogConfig> NormalConfigs = Resources.LoadAll<DialogConfig>("Scriptable/NormalNPC").ToList();
